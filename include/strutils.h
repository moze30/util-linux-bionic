...
/* strverscmp is a GNU extension not provided by Bionic (or musl).
 * This is the glibc implementation (LGPL-2.1-or-later), made static inline
 * so it can be shared by all translation units that include this header
...
/* versionsort is the scandir(3) counterpart of strverscmp(), also a GNU
 * extension not provided by Bionic (or musl). */
